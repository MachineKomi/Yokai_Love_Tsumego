# Yokai_Love_Tsumego
Yokai Love Tsumego is an AI tsumego (go puzzle) visual novel dating sim. Solve tsumego problems daily, and learn with AI to climb the infinite tower, get stronger at go, and unlock new beautiful Goddesses and Devils companions.
# Yokai Love Tsumego
...
**Tsumego Tower** is a hybrid casual puzzle game and visual novel with a "Nostalgic 90s Anime" aesthetic.
...
This project employs a hybrid licensing model to allow open-source code collaboration while protecting the game's artistic intellectual property.
...
This means you are free to study, modify, and redistribute the code, but if you use it to build a networked service or game, you must open-source your entire project under the same license. See the [LICENSE](LICENSE) file for details.
...
1.  **Clone the repository:**
    ```bash
    git clone [https://github.com/yourusername/tsumego-tower.git](https://github.com/yourusername/tsumego-tower.git)
    cd tsumego-tower
    ```
