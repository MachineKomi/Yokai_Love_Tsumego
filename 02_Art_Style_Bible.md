...
### C. Combat Visuals (Abstract RPG)
*   **Style:** Text-heavy, imagination-driven. No animated sprites.
*   **Portraits:** Static, high-quality character art that reacts to damage (shake/flash red) or victory (glow gold).
*   **Combat Log:** A fast-scrolling, detailed text log describing the action.
*   **VFX:** Juicy particle explosions and floating damage numbers overlaid on the background.
...
* [ ] **Waifu 02 (Oni):** Generate full sprite sheet with 5 expressions + 1 CG scene.
* [ ] **Board VFX:** Create the glowing "heat map" and "best move" particle effects in PixiJS.
* [ ] **Combat Visuals:** Implement text-based combat log and particle effects.