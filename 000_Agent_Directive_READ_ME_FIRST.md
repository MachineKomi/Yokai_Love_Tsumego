...
Create the basic React component structure. Implement a minimal PixiJS board renderer that can takHello Agent. We are starting a new project called "Yokai Love Tsumego". Black and White stones.
